...
void SdlGamepadKeyNavigation::onPollingTimerFired()
{
    ...
    for (auto gc : std::as_const(m_Gamepads)) {
        ...
        // Deliberately outside the repeat-delay gate — that gate is about how often a held
        // direction repeats, and this is about which device the prompts should name.
